...
object E11 extends ExperimentSettings {
  ...
  def defaultConfig: Configuration = Configuration(
    Simulation(
      ...
      experiment_length = 80 * 500, //500 at least edits
      robot_count = 10,
  ...
  def configVariation: Seq[Variation[Configuration, _]] = {
    ...
    val foragingArena2 = (("experiments/parametrized-foraging2.argos", Map("premature_edit_if_stuck" -> "", "stuck_time" -> "5", "variant" -> "foraging", "light_nodes" -> "8", "light_threshold" -> "0.1")), None)
